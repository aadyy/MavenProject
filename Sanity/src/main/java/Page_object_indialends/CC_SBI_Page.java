...
protected WebDriver driver;
	...
	public void check_Eligibility() throws Exception {
		...
		@SuppressWarnings("unused")
		WebElement element = wait2.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#li_birthdate")));
			...
			try {
				...
				System.out.println("PanKarza popup is not click");
			}
	...
	public void general_Information() throws Exception {
		...
		WebDriverWait wait = new WebDriverWait(driver, 100);
		@SuppressWarnings("unused")
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(ClickCard));
