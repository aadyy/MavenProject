...
public class CC_RBL_Lender_Page  extends Base {

protected WebDriver driver;
	
	//=========================== Short Form Page Locators =============================================================== //
    	
    @FindBy(how=How.CSS, using="#mainNav > div.container-fluid.md-pad10b.sm-pad0b > div.col-xs-12.col-sm-12.col-md-9.pad0 > div.collapse.navbar-collapse.navbar-ex1-collapse.pad10t.sm-pad0t.full-width > ul > li.dropdown > a")
    private WebElement clickCC;
 ...
 //============= General Information ========================================= //
	...
	public CC_RBL_Lender_Page(WebDriver driver) {
		this.driver=driver;
