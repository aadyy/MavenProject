...
public class PL_Page_SE extends Base {
	...
	@FindBy(how = How.CSS, using = "#self-emp")
	...
	public PL_Page_SE(WebDriver driver) {
		this.driver = driver;
	...
	public void enterBasicdetailsToCheckLoanEligibility() throws Exception {
		...
		salaried.click();
       Thread.sleep(2000);
		driver.findElement(By.cssSelector("#div_itr > div > div.select-selected.select-arrow-active")).click();
		driver.findElement(By.cssSelector("#div_itr > div > div.select-items > div:nth-child(1)")).click();
