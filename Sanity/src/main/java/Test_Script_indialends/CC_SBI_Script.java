...
public class CC_SBI_Script extends Base
{
	@Test(priority=1)
	public void CCBasicDetailsPage() throws Exception 
	{
		...
		Page_object_indialends.CC_SBI_Page detailsPage = PageFactory.initElements(driver, Page_object_indialends.CC_SBI_Page.class);
