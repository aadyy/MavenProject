...
public class CC_RBL_Lender_Script extends Base {
	...
	public void fillBasicDetailsPage() throws Exception 
	{
		...
		Page_object_indialends.CC_RBL_Lender_Page detailsPage = PageFactory.initElements(driver, Page_object_indialends.CC_RBL_Lender_Page.class);
